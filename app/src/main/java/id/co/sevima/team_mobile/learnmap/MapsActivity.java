package id.co.sevima.team_mobile.learnmap;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                Toast.makeText(MapsActivity.this, String.valueOf(latLng.latitude) + "," + String.valueOf(latLng.longitude), Toast.LENGTH_LONG).show();
            }
        });
